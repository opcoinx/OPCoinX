 ...
 * OPCX system. There are three: the main network on which people trade goods
...
public:
    ...
    int OpcxBadBlockTime() const { return nOpcxBadBlockTime; }
    int OpcxBadBlocknBits() const { return nOpcxBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nOpcxBadBlockTime;
    unsigned int nOpcxBadBlocknBits;
