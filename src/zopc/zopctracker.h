...
#ifndef OPCX_ZOPCTRACKER_H
#define OPCX_ZOPCTRACKER_H
...
public:
    CzOPCTracker(std::string strWalletFile);
    ~CzOPCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzOPCWallet* zOPCWallet = NULL);
