...
#ifndef OPCX_ZOPCWALLET_H
#define OPCX_ZOPCWALLET_H
...
public:
    CzOPCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZOPC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZOPC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
