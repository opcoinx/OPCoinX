...
{   
    ...
    labelOverviewHeaderLeft->setStyleSheet("QLabel {color : white; }");
    ...
    transactionSumLabel->setStyleSheet("QLabel {color : white; }");
    ...
    transactionSum->setStyleSheet("QLabel {color : white; }");
