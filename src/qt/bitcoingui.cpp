...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OPCoinX address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OPCoinX Core"), this);
    aboutAction->setStatusTip(tr("Show information about OPCoinX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OPCoinX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OPCoinX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OPCoinX addresses"));
    ...
    openAction->setStatusTip(tr("Open a OPCoinX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OPCoinX Core help message to get a list with possible OPCoinX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OPCoinX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OPCoinX network", "", count));
}
...
{
    QString strTitle = tr("OPCoinX Core"); // default title
