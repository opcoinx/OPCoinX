...
static void NotifyzOPCReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzOPCReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzOPCReset.connect(boost::bind(NotifyzOPCReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzOPCReset.disconnect(boost::bind(NotifyzOPCReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zopcTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus, fWrongSeed);
}
