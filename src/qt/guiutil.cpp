...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a OPCoinX address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
{
    // return if URI is not valid or is no OPCoinX: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "OPCoinX.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for OPCoinX.lnk
