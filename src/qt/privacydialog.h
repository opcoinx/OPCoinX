...
public:
    ...
    void setZOpcxControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzOPCX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzOPCX_clicked();
    void on_pushButtonZOpcxControl_clicked();
