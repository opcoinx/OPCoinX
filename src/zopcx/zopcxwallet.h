...
#ifndef OPCX_ZOPCXWALLET_H
#define OPCX_ZOPCXWALLET_H
...
public:
    CzOPCXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZOPCX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZOPCX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
