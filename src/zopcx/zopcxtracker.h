...
#ifndef OPCX_ZOPCXTRACKER_H
#define OPCX_ZOPCXTRACKER_H
...
public:
    CzOPCXTracker(std::string strWalletFile);
    ~CzOPCXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzOPCXWallet* zOPCXWallet = NULL);
