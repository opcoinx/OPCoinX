...
This mechanism has been integrated into Bitcore-Node-OPCX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/OPCX-Project/insight-api-opcx#web-socket-api](https://github.com/OPCX-Project/insight-api-opcx#web-socket-api)
* API: [https://github.com/OPCX-Project/insight-api-opcx#swifttx-transactions](https://github.com/OPCX-Project/insight-api-opcx#swifttx-transactions)
...
By default, the OPCX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the OPCX Core daemon:
