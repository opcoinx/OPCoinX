...
1. Clone the OPCX Core source code:

        git clone https://github.com/opcx-project/opcx
        cd opcx
...
OPCX Core is now available at `./src/opcxd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/OPCX"

    touch "/Users/${USER}/Library/Application Support/OPCX/opcx.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/OPCX/opcx.conf"

The first time you run opcxd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/opcxd -daemon # Starts the opcx daemon.
    ./src/opcx-cli --help # Outputs a list of command-line options.
    ./src/opcx-cli help # Outputs a list of RPC commands when the daemon is running.
