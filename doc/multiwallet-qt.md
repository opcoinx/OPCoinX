...
In order to support loading of multiple wallets in opcx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is opcx.cpp.
...
Changes to opcx.cpp
----------------------
opcx.cpp is the entry point into opcx-qt, and as such, will require some minor modifications to provide hooks for
