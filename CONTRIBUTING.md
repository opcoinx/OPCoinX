Contributing to OPCX Core
============================

The OPCX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/opcx-project/opcx/blob/master/doc/translation_process.md)
...
The following applies to code changes to the OPCX Core project, and is not to be
confused with overall OPCX Network Protocol consensus changes.

Whether a pull request is merged into OPCX Core rests with the project merge
...
Patches that change OPCX consensus rules are considerably more involved than
...
Where a patchset proposes to change the OPCX consensus, it must have been
...
The project leader is the release manager for each OPCX Core release.
